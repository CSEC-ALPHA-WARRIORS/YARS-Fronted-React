...
const RegistrationValidation = yup.object().shape({
    ...
    phonenumber: yup
        .string()
        .matches(ethiopianPhoneRegex, { message: 'Please enter valid phone number' })
    ...
    confirm: yup
        .string()
        .min(6).oneOf([yup.ref('password'), null], 'Passwords must match')
        .required("Password is required"),
    city: yup
        .string()
        .max(15)
    ...
    woreda: yup
        .string()
        .max(15)
        .required("Woreda name is required"),
    kebele: yup
        .string()
        .max(15)
